...
- [ ] Sprint 4.16A: adicionar resumo da posição atual para investimentos MOVEMENTS.
- [ ] Validar cálculos, ausência de cotação, ativos ACCOUNT e neutralidade no saldo.
- [ ] Executar testes focados e typecheck, sem suíte completa ou build.
