...
const CLASSIFICATIONS: Record<string, B3Classification> = {
  ...
  COMPRA: investment("BUY", "Compra com potencial impacto na posição; não será importada nesta etapa."),
  "COMPRA / VENDA": investment("BUY_SELL", "Operação combinada que exige revisão; compra e venda não serão inferidas."),
  RESGATE: investment("REDEMPTION", "Resgate com potencial redução de posição; não será importado nesta etapa."),
